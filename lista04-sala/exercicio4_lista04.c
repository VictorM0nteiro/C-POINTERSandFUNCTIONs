...
#include <stdlib.h>
    int main(){
        ...
        printf("pont_a(endereco de a) = %u\n", pont_a); // endereço de a
        printf("*pont_a(valor de a;) = %u\n", *pont_a); // valor de a;

        printf("\n");

        printf("pont_pont_a(endereço de pont_a) = %u\n", pont_pont_a); // endereço de pont_a
        printf("*pont_pont_a(valor de pont_a que e o endereço de a) = %u\n", *pont_pont_a); // valor de pont_a que é o endereço de a
        printf("**pont_pont_a(emprime o valor de a;) = %u\n", **pont_pont_a);// emprime o valor de a;

        printf("\n");

        printf("pont_pont_pont_a(endereco de pont_pont_a;) = %u\n", pont_pont_pont_a); // endereco de pont_pont_a;
        printf("*pont_pont_pont_a(valor de pont_pont_a que e o endereco de pont_a;) = %u\n", *pont_pont_pont_a); // valor de pont_pont_a que e o endereco de pont_a;
        printf("**pont_pont_pont_a(valor de pont_a que e o endereco de a) = %u\n", **pont_pont_pont_a); // valor de pont_a que é o endereço de a
        printf("***pont_pont_pont_a(imprime o valor de a;) = %u\n", ***pont_pont_pont_a); // imprime o valor de a;
        printf("&pont_pont_pont_a(endereco de pont_pont_pont_a) = %u\n", &pont_pont_pont_a); //endereco de pont_pont_pont_a
